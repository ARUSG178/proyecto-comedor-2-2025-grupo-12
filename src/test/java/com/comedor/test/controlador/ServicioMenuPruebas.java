...
public class ServicioMenuPruebas {
    ...
    void setUp() {
        ...
        administrador = new Administrador("1001", "admin123", "ADMIN001");
        estudiante = new Estudiante("2001", "pass123", "Computacion", "Ciencias");
        empleado = new Empleado("3001", "pass456", "Analista", "RRHH", "EMP001");
    }
    ...
    void testConfigurarMenu_Admin_Desayuno() {
        ...
        for (Platillo platillo : platillos) {
            nuevoMenu.agregarPlatillo(platillo);
        }
        ...
        assertAll("Verificar configuración completa del menú de desayuno",
            ...
            () -> assertTrue(menuActualizado.obtEstado(), 
    ...
    void testConfigurarMenu_Estudiante_Denegado() {
        ...
        Menu menuOriginal = servicio.obtenerMenu("Desayuno");
        
        Menu nuevoMenu = new Menu("Desayuno");
        nuevoMenu.setNombre("Desayuno Especial");
        nuevoMenu.agregarPlatillo(new Platillo("Plato especial", 5000.0));
    ...
    void testConfigurarMenu_Empleado_Denegado() {
        // Arrange
        Menu menuOriginal = servicio.obtenerMenu("Almuerzo");
        
        Menu nuevoMenu = new Menu("Almuerzo");
        nuevoMenu.setNombre("Almuerzo de Gala");
        nuevoMenu.agregarPlatillo(new Platillo("Plato gourmet", 8000.0));
    ...
    void testConfigurarMenu_PlatillosNull() {
        ...
        // Caso límite: sin platillos agregados
    ...
    void testConfigurarMenu_PlatillosVacios() {
        ...
        // Caso límite: lista vacía - no se agregan platillos
    ...
    void testConfigurarMenu_UnPlatillo() {
        ...
        nuevoMenu.agregarPlatillo(new Platillo("Café con leche", 1200.0));
    ...
    void testConfigurarMenu_MuchosPlatillos() {
        ...
        for (Platillo platillo : muchosPlatillos) {
            nuevoMenu.agregarPlatillo(platillo);
        }
