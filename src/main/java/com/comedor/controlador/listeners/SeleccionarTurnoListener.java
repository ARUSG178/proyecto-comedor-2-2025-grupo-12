...
public class SeleccionarTurnoListener implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        try {
            ...
            try (FileOutputStream out = new FileOutputStream("src/main/resources/config/verification_request.properties")) {
            ...
            JOptionPane.showMessageDialog(parentFrame, 
                ...
                "Para completar la compra, usa el botón \"Reconocimiento Facial\"\n" +
                "en el menú lateral (ícono 👤) para autorizar el pago con tu rostro.", 
